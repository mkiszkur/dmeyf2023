...
#Experimento <- Experimento Colabortivo Prueba 003
...
PARAM$finalmodel$optim$num_iterations <- 1089 ### <- Cambiar
PARAM$finalmodel$optim$learning_rate <- 0.103734278324661 ### <- Cambiar
PARAM$finalmodel$optim$feature_fraction <- 0.211060645473065 ### <- Cambiar
PARAM$finalmodel$optim$num_leaves <- 584 ### <- Cambiar
PARAM$finalmodel$optim$min_data_in_leaf <- 48080 ### <- Cambiar
...
PARAM$semillerio <- c(100189, 100193, 100207, 100213, 100237, 100267,
                      100271, 100279, 100291, 100297, 100313, 100333,
