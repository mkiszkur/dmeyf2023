...
PARAM$experimento <- "K03_LGBM_005"
...
PARAM$finalmodel$optim$num_iterations <- 238
PARAM$finalmodel$optim$learning_rate <- 0.119124306357898
PARAM$finalmodel$optim$feature_fraction <- 0.939804760301111
PARAM$finalmodel$optim$num_leaves <- 851
PARAM$finalmodel$optim$min_data_in_leaf <- 35521
PARAM$finalmodel$optim$neg_bagging_fraction <- 0.855006096952541
